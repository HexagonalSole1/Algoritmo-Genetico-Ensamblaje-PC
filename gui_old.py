...
# Create sections with frames
    ...
    def get_component_browser_data(self, component_type: str) -> List[Dict[str, str]]:
        ...
        # Mapeo de métodos de obtención por tipo de componente
        component_getters = {
            'cpu': data_manager.get_cpus,
            'gpu': data_manager.get_gpus,
            'ram': data_manager.get_rams,
            'storage': data_manager.get_storages,
            'motherboard': data_manager.get_motherboards,
            'psu': data_manager.get_psus,
            'cooling': data_manager.get_coolings,
            'case': data_manager.get_cases
        }

        # Obtener la lista de componentes según el tipo
        components = component_getters.get(component_type.lower(), lambda: [])()
        ...
        for component in components:
            try:
                ...
                print(f"⚠️ Error procesando componente de tipo {component_type}: {e}")
